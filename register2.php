...
<form action="register2.php" method="POST">
  <div class="container">
    ...
    <input name="repeatpassword"type="password" placeholder="Enter RepeatPassword"  required><br/>
  ...
  <div class="container signin">
    <p>Already have an account? <a href="doctor-login.php">Sign in</a>.</p>
  </div>
</form>
   ...
   if (isset($_POST['submit']))
   {
	   ...
	   if ($password==$repeatpassword){
		 ...
		 if(mysqli_num_rows($query_run)>0)
		 {
			 ...
			 $query= "insert into registration(firstName,lastName,email,username,password,repeatpassword)
			 values ('$firstName','$lastName' ,'$email','$username','$password','$repeatpassword' )";
			  $query_run=mysqli_query($conn,$query);
			  if($query_run){
